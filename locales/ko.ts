export default {
  ...
  backToBlog: "글 목록으로",
  backToHome: "홈으로",
  aboutTitle: "안녕하세요, 민웅기입니다 :)",
  aboutMe: `현재는 프론트엔드 개발자로 일하고 있습니다.
프론트엔드 개발자로서 빠르게 변화하는 기술을 배우고 적용하는 것을 즐깁니다. 
또한, 사용자 경험을 중요시하며 사용자에게 최고의 경험을 제공하기 위해 노력합니다.`,
  mainText: "꿈이였나요, 아니면 꿈의 시작이였던가요?",
  subText: "이게 뭐였든, 과정이 중요하다고 생각해요.",
